        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
          {filtered.map((character) => {
            ...
            const headingClasses = isPlayerCharacter
              ...
              : "text-[var(--cyber-magenta)] hover-magenta-to-cyan";
                      ...
                      <div className="flex flex-wrap gap-2">
                        {(expandedGroups.has(character.id) 
                          ...
                          <Link
                            ...
                            className="inline-flex items-center rounded-full border border-[var(--cyber-magenta)]/70 bg-[var(--cyber-magenta)]/10 px-2 py-1 text-[9px] font-mono uppercase tracking-[0.25em] text-[var(--cyber-magenta)] hover-magenta-to-cyan transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--cyber-magenta)] whitespace-nowrap"
                          >
                            {organization.name}
                          </Link>
                        ))}
                        {!expandedGroups.has(character.id) && character.organization_characters.length > 4 && (
                          <button
                            ...
                            className="inline-flex items-center rounded-full border border-dashed border-[var(--cyber-magenta)]/50 px-2 py-1 text-[9px] font-mono uppercase tracking-[0.25em] text-[var(--cyber-magenta)] hover-magenta-to-cyan transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--cyber-magenta)] whitespace-nowrap"
                          >
                    ...
                    <div className="pointer-events-auto mt-2">
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {expandedCharacters.has(character.id) && character.session_characters.length > 3 && (
                          <button
                            onClick={() => toggleCharacterSessions(character.id)}
                            className="inline-flex items-center rounded-full border border-[var(--cyber-magenta)]/70 bg-[var(--cyber-magenta)]/10 px-2 py-1 text-[10px] font-mono uppercase tracking-[0.3em] text-[var(--cyber-magenta)] hover-magenta-to-cyan transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--cyber-magenta)]"
                          >
                            Show less
                          </button>
                        )}
