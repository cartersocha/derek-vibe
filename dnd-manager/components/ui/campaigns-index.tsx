                      ...
                      <div className="flex flex-wrap gap-1 sm:gap-2">
                        {campaign.characters.map((character) => (
                          <Link
                            ...
                            className={cn(
                              "inline-flex items-center rounded px-[var(--pill-padding-x-small)] py-[var(--pill-padding-y-small)] text-[9px] sm:text-[10px] font-mono uppercase tracking-widest transition-colors focus-visible:outline-none focus-visible:ring-2",
