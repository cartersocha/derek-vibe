                ...
                {canCreateNew && (
                  <li>
                    <button
                      ...
                      disabled={isPending}
                      className="flex w-full items-center justify-between px-4 py-3 text-left text-sm text-[var(--cyber-cyan)] transition-colors duration-150 hover:bg-[var(--bg-card)]/60"
                    >
                      <span className="truncate">
