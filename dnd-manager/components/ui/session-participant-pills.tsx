  ...
  const organizationPills = showOrganizations
    ? uniqueOrganizations.map((organization) => (
        <Link
          ...
          className="inline-flex items-center rounded border border-[var(--cyber-magenta)]/70 bg-[var(--cyber-magenta)]/10 px-2 py-1 text-[10px] font-mono uppercase tracking-widest text-[var(--cyber-magenta)] hover:text-[var(--cyber-cyan)] hover:border-[var(--cyber-cyan)]/70 hover:bg-[var(--cyber-cyan)]/10 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--cyber-magenta)]"
        >
          {organization.name}
        </Link>
      ))
