  ...
  const playerPills = sortedPlayers.map((player) => {
    return (
      <Link
        ...
        className={cn(
          'inline-flex items-center rounded px-2 py-1 text-[10px] font-mono uppercase tracking-widest transition-colors focus:outline-none focus-visible:ring-2 max-w-[250px]',
